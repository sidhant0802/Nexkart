    ...
    onSubmit: (values, { resetForm }) => {
      dispatch(
        createCoupon({
          coupon: {
            ...values,
            validityStartDate: values.validityStartDate?.toISOString() ?? null,
            validityEndDate:   values.validityEndDate?.toISOString()   ?? null,
          },
      ...
      <div style={{ maxWidth: "560px", width: "100%" }}>
        ...
        >
          ...
          <div style={{
            ...
            >
              <input
                ...
                style={{
                  ...inputStyle(!!(formik.touched.code && formik.errors.code)),
          ...
          <div style={{
            ...
            <Field
              label="Start Date"
              error={formik.touched.validityStartDate
                ? (formik.errors.validityStartDate as string)
                : undefined}
            >
              <DatePicker
                value={formik.values.validityStartDate}
                onChange={(d) => formik.setFieldValue("validityStartDate", d)}
                slotProps={{
                  textField: {
                    size:  "small",
                    error: !!(
            ...
            <Field
              label="End Date"
              error={formik.touched.validityEndDate
                ? (formik.errors.validityEndDate as string)
                : undefined}
            >
              <DatePicker
                value={formik.values.validityEndDate}
                onChange={(d) => formik.setFieldValue("validityEndDate", d)}
                slotProps={{
                  textField: {
                    size:  "small",
                    error: !!(
          ...
          <Field
            ...
            error={formik.touched.minimumOrderValue
          ...
          <button
            type="submit"
            disabled={adminCoupon.loading || !formik.isValid}
            style={{
              padding:       "12px",
              borderRadius:  "12px",
              border:        "none",
              ...
              fontWeight:    700,
              color:         "#fff",
              background:    adminCoupon.loading || !formik.isValid
                ? (isDark ? "#374151" : "#d1d5db")
                : "linear-gradient(135deg, #6366f1, #a855f7)",
              boxShadow:     adminCoupon.loading || !formik.isValid
                ? "none"
