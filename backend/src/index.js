...
// ✅ Silence Chrome DevTools probe (harmless)
app.get("/.well-known/appspecific/com.chrome.devtools.json", (req, res) => {
  res.status(204).end();
});

// ══════════════════════════════════════════════════════════════
// ── BullMQ Dashboard (CSP-friendly) ───────────────────────────
// ══════════════════════════════════════════════════════════════
...
const searchRouters         = require("./routers/searchRoutes.js");    // ✅ NEW
...
app.use("/api/search",          searchRouters);                        // ✅ NEW
...
// ══════════════════════════════════════════════════════════════
// ── Start Server (with Socket.IO + Search) ────────────────────
// ══════════════════════════════════════════════════════════════
...
server.listen(port, async () => {
  ...
  // ✅ Atlas Search (auto-indexed by MongoDB)
  try {
  ...
  console.log(`🔍 Search: MongoDB Atlas Search (free)`);
});